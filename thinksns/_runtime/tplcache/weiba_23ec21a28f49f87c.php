                 ...
                 <div id="col5" class="st-index-main">
                    <div class="extend-foot">
                        ...
                        <div class="weiba-sort f9 clearfix">
                            <span>共有<?php echo ($postList["count"]); ?>个帖子</span>
                        </div>
                        <div class="weiba_postlist">
                           <ul>
                            <?php if(is_array($postList["data"])): ?><?php $i = 0;?><?php $__LIST__ = $postList["data"]?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><li><div class="name"><span class="right num"><i class="arrow-weiba"></i><?php echo ($vo["reply_count"]); ?></span><a target="_blank" href="<?php echo U('weiba/Index/postDetail',array('post_id'=>$vo['post_id']));?>"><span style="vertical-align:-2px;"><?php echo ($vo["title"]); ?></span><?php if(strstr($vo['content'],'<img')){ ?><i class="ico-img"></i><?php } ?><?php if($vo['top']==2){ ?><i class="ico-bar-top ml5">置顶</i><?php } ?><?php if($vo['digest']==1){ ?><i class="ico-bar-fine ml5">精华</i><?php } ?></a></div>
